...
import { VaultApiError, vaultApi } from '../vault/api.ts';
import { isApiConfigured } from '../vault/api-base-url.ts';
import { getSession } from '../vault/auth-client.ts';
import {
  checkPasskeyPrfCapability,
  PasskeyPrfError,
  type PrfCapability,
} from '../vault/passkey-prf.ts';
